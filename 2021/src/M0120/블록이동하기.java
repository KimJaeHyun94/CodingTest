...
/*
 * @See https://leveloper.tistory.com/102
 * @Author : AKKabiyo
 *
 */
public class 블록이동하기 {
	...
	private final int[] rdx = { -1, 1, 1, -1 };	//대각선
	...
	private int bfs(boolean[][][] visit) {
		...
		while (!q.isEmpty()) {
			Robot temp = q.poll();
			int x = temp.x, y = temp.y, dir = temp.dir, time = temp.time, ox = temp.ox, oy = temp.oy; // 변수 선언
